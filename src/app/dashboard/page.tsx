...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 py-2">
      {/* Page title */}
      <div>
        <p className="text-xs font-semibold tracking-[0.22em] uppercase mb-1" style={{ color: '#8B4513' }}>
          Healthworx Capital
        </p>
        <h1 className="text-2xl font-extrabold tracking-tight" style={{ letterSpacing: '-0.02em', color: '#1C0F07' }}>
          Pitch Dashboard
        </h1>
